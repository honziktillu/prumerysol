...
const stoleElement = document.getElementsByClassName(
  "ig_Item igtbl_Item ig_10e26aa4_r1 ig_Header igtbl_Header ig_10e26aa4_r4"
)[1];
...
const getResults = (weightValues, table) => {
  ...
  [...rows].map((row) => {
    ...
    [
      ...rows[foo - 1].getElementsByTagName("td"),
    ][0].innerHTML += `<p style="color: red; font-weight: bold;">Průměr: ${averageResult}</p>`;
  });
};
